...
"
  ...
  spec.executables = ["appraisal", "bundle", "bundle-audit", "bundler-audit", "code_climate_reek", "erb", "gem_checksums", "htmldiff", "irb", "kettle-changelog", "kettle-commit-msg", "kettle-dev-setup", "kettle-dvcs", "kettle-pre-release", "kettle-readme-backers", "kettle-release", "kramdown", "ldiff", "nokogiri", "racc", "rake", "rbs", "rdbg", "rdoc", "reek", "ri", "rspec", "rubocop", "rubocop-gradual", "ruby-parse", "ruby-rewrite", "setup", "standardrb", "test.bash", "thor", "yard", "yard-junk", "yardoc", "yri"]
